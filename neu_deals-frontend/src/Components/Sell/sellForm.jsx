                        ...
                        <hr/>
                            ...
                            <div className="address">
                                <div class="form-group my-2">
                                    ...
                                    <input type="text" class="form-control" id="AddressLine1" placeholder="360 Huntington Ave, Boston, MA 02115, MA 02115" value={addressLine1} onChange={(event) => setAddressLine1(event.target.value)}/>
                                </div> 
                                <div class="form-row">
